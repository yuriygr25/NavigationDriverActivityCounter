package com.example.yura.navigationdriveractivitycounter;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            TextView mInfoTextView = (TextView) findViewById(R.id.nav_gallery);
            mInfoTextView.setText(Integer.toString(parseInt(mInfoTextView.getText().toString())-1));
        } else if (id == R.id.nav_slideshow) {
            TextView mInfoTextView = (TextView) findViewById(R.id.nav_slideshow);
            mInfoTextView.setText(Integer.toString(parseInt(mInfoTextView.getText().toString())+1));
